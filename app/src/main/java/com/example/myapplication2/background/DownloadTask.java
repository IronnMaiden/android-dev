package com.example.myapplication2.background;
...
import com.example.myapplication2.AsyncActivity;
...
public class DownloadTask extends AsyncTask<String,Integer,Void> { //inputtype, progresstype, resulttype
    ...
    protected Void doInBackground(String... strings) {  //bg thread --- bawarchi--cook
        ...
        try {
            ...
            for(int i=1; i<=20; i++){
                Thread.sleep(100);
                publishProgress(89*5); //5% has been downloaded -- publishprogress will call onProgressUpdate
            }
        }
